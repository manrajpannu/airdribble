export default function CommunityPage() {
  return (
    <section className="space-y-6">
      <header className="retro-card-gradient-a border-2 border-border p-6 shadow-(--shadow-sm)">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <article className="retro-card-gradient-b border-2 border-border p-5 shadow-(--shadow-xs)">
        ...
        <article className="retro-card-gradient-c border-2 border-border p-5 shadow-(--shadow-xs)">
